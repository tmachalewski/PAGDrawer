...
- **Node Details**: Click-to-view tooltip
...
│   └── test_frontend.py        # 36 Playwright tests
└── Docs/
...
| Playwright Browser | 36      | pytest-playwright |
| **TOTAL**          | **111** |                   |
...
## Recent Changes (2026-01-12 to 2026-01-13)
